function varargout = mullar(varargin)
% MULLAR MATLAB code for mullar.fig
%      MULLAR, by itself, creates a new MULLAR or raises the existing
%      singleton*.
%
%      H = MULLAR returns the handle to a new MULLAR or the handle to
%      the existing singleton*.
%
%      MULLAR('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MULLAR.M with the given input arguments.
%
%      MULLAR('Property','Value',...) creates a new MULLAR or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before mullar_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to mullar_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help mullar

% Last Modified by GUIDE v2.5 21-Jul-2015 13:50:28

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @mullar_OpeningFcn, ...
                   'gui_OutputFcn',  @mullar_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before mullar is made visible.
function mullar_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to mullar (see VARARGIN)

% Choose default command line output for mullar
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes mullar wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = mullar_OutputFcn(hObject, eventdata, handles) 
...
while(1);
    ...
    set(handles.retry,'String','Retry Please First Must be Greater Than Second');
